            ...
            <motion.div className="showcase-section-inner" style={{ opacity: opacity1 }}>
              <div className="showcase-content">
                ...
                <div className="showcase-actions">
                  <button className="btn btn-primary" onClick={() => { window.location.href = 'https://sevasetu-volunteer.onrender.com/'; }}>
          ...
          <div className="showcase-slide">
            <motion.div className="showcase-section-inner reverse" style={{ opacity: opacity2 }}>
              <div className="showcase-content">
                ...
                <div className="showcase-actions">
                  <button className="btn btn-primary" style={{ gap: '10px' }} onClick={() => { window.location.href = 'https://sevasetu-admin.onrender.com/'; }}>
                    Open Dashboard
                  </button>
                </div>
              </div>
